package com.mrclrchtr.android.example.asesor;
...
public class tutor_virtual extends AppCompatActivity {
    ...
    private final static short AMPLITUDE_DETECTOR = 300; // 700 is good enough for acoustic
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutor_virtual);
